            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="information_file.php" class="sidebar-link">
                        ...
                        <li class="sidebar-item">
                            <a href="machine_master.php" class="sidebar-link">
                        ...
                        <li class="sidebar-item">
                            <a href="partno_master.php" class="sidebar-link">
                                <i class="fas fa-box"></i>
                                <span>Part Number Master</span>
                            </a>
                        </li>
